      ...
      <script>
        function showSearch_<?= $i+1 ?>(){
          ...
          if(!document.getElementById('profile-tab_<?= $i+1 ?>').classList.contains('active')){
            document.getElementsByClassName('li-search')[<?= $i ?>].classList.remove('d-none');
            document.getElementsByClassName('li-search')[<?= $i ?>].classList.add('d-flex');
          } 
          else {
            document.getElementsByClassName('li-search')[<?= $i ?>].classList.add('d-none');
            document.getElementsByClassName('li-search')[<?= $i ?>].classList.remove('d-flex');
          }
        }
