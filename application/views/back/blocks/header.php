...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        ...
        <a href="<?php echo base_url(); ?>panel/assets" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'assets') {
          echo 'active';
        } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-lemon tx-20"></i>
                <span class="menu-item-label">Elementy layoutu</span>
            </div>
        </a>

        <?php $links = ['Opisy i film' => 'banner/form/update/1', 'Partnerzy' => 'partners', 'Menu Ikony<br>Social Media' => 'menu_icons']; ?>
        <a href="#" class="br-menu-link
        <?php if (in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2) . '/form/update/1', $links)) {
          echo 'show-sub';
        } ?>">
            <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="<?= base_url() . 'panel/' . $value ?>"
                    class="nav-link <?php if ($this->uri->segment(2) == $value || $this->uri->segment(2) . '/form/update/1' == $value) echo 'active' ?>"><?= $key ?></a>
            </li>
            <?php endforeach; ?>
        </ul>

        <?php $links = ['Kafelki' => 'realizations', 'Opisy' => 'realizations_descriptions', 'Filtry' => 'filters']; ?>
        <a href="#" class="br-menu-link
        <?php if (in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2) . '/form/update/1', $links)) {
          echo 'show-sub';
        } ?>">
        ...
        <a href="<?php echo base_url(); ?>panel/realizacje_podstrona" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'realizacje_podstrona') {
          echo 'active';
        } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-clipboard tx-20"></i>
                <span class="menu-item-label">Realizacje - Podstrona</span>
            </div>
        </a>

        <?php $links = ['Kafelki' => 'team', 'Opisy' => 'team_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if (in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2) . '/form/update/1', $links)) {
          echo 'show-sub';
        } ?>">
            <div class="br-menu-item">
                ...
                <span class="menu-item-label">Zespół</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Kafelki' => 'services', 'Opisy' => 'services_descriptions',]; ?>
        <a href="#" class="br-menu-link
        <?php if (in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2) . '/form/update/1', $links)) {
          echo 'show-sub';
        } ?>">
        ...
        <?php $links = ['Nagłówki' => 'franchise_headers', 'Model' => 'franchise_model', 'Korzyści' => 'franchise_benefits', 'Korzyści opisy' => 'franchise_benefits_desc', 'Sprawdzony biznes' => 'franchise_business', 'Support' => 'franchise_support', 'Support opisy' => 'franchise_support_desc', 'Tło niebieskiej<br>sekcji' => 'franchise_blue_section_bg', 'Współpraca' => 'franchise_cooperation', 'Współpraca opisy' => 'franchise_cooperation_desc', 'Symulacja zarobków' => 'franchise_simulation', 'Partnerzy' => 'franchise_partners', 'Partnerzy opisy' => 'franchise_partners_desc', 'Masz pytania?' => 'franchise_questions', 'Przedstawiciele' => 'franchise_representatives', 'Żółty formularz<br>tło i daniel' => 'franchise_yellow_form', 'Niebieski formularz<br>tło i daniel' => 'franchise_blue_form']; ?>
        <a href="#" class="br-menu-link
        <?php if (in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2) . '/form/update/1', $links)) {
          echo 'show-sub';
        } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-dollar-sign tx-20"></i>
                <span class="menu-item-label">Franczyza</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Opisy' => 'contact_descriptions', 'Przyciski' => 'contact_buttons', 'Tematy wiadomości<br>franczyzy' => 'franchise_subjects']; ?>
        <a href="#" class="br-menu-link
        <?php if (in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2) . '/form/update/1', $links)) {
          echo 'show-sub';
        } ?>">
        ...
        <!-- <?php $links = ['Baza wiedzy' => 'knowledge/form/update/1', 'Dlaczego?' => 'why', 'Dlaczego opisy' => 'why_descriptions/form/update/1', 'Poradniki' => 'guides', 'Poradniki opisy' => 'guides_descriptions/form/update/1']; ?>
        <a href="#" class="br-menu-link
        <?php if (in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2) . '/form/update/1', $links)) {
          echo 'show-sub';
        } ?>">
        ...
        <ul class="br-menu-sub nav flex-column">
          <?php foreach ($links as $key => $value) : ?>
          <li class="nav-item"><a href="<?= base_url() . 'panel/' . $value ?>" class="nav-link <?php if ($this->uri->segment(2) == $value || $this->uri->segment(2) . '/form/update/1' == $value) echo 'active' ?>"><?= $key ?></a></li>
          <?php endforeach; ?>
        </ul> -->
        ...
        <nav class="nav">
          ...
          if ($unreadMessage == true) : ?>
            ...
            foreach (array_reverse($mails) as $value) : $i++; ?>
                        <a href="<?php echo base_url(); ?>panel/mails/show/<?php echo $value->id; ?>"
                            class="media-list-link <?php if ($value->answer == 0) {
                                                                                                                      echo 'read';
                                                                                                                    } ?>">
                            <div class="media pd-x-20 pd-y-15">
                                <?php if ($value->answer == 1) : ?>
                                <img src="<?php echo base_url(); ?>assets/back/img/icons/checked.png"
                                    class="wd-40 rounded-circle" alt="">
                                <?php else : $unreadMessage == true; ?>
                                <img src="<?php echo base_url(); ?>assets/back/img/icons/cancel.png"
                                    class="wd-40 rounded-circle" alt="">
                                <?php endif; ?>
                                <div class="media-body">
                                    <div class="d-flex align-items-center justify-content-between mg-b-5">
                                        ...
                                        <span
                                            class="tx-11 tx-gray-500"><?php echo date('d/m/Y', strtotime($value->created)); ?></span>
                                    </div><!-- d-flex -->
                ...
                break;
                        ...
                        <div class="pd-y-10 tx-center bd-t">
                            <a href="<?php echo base_url(); ?>panel/mails" class="tx-12"><i
    ...
    <div class="tab-content">
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="company" name="company"
                        onchange="updateField('company' , 'contact_settings')" value="<?php echo $contact->company; ?>"
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="address" name="address"
                        onchange="updateField('address' , 'contact_settings')" value="<?php echo $contact->address; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="zip_code" name="zip_code"
                        onchange="updateField('zip_code' , 'contact_settings')"
                        value="<?php echo $contact->zip_code; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
                    ...
                    <div class="pd-y-20 pd-l-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="label1" name="label1"
                                onchange="updateField('label1' , 'contact_settings')"
                                value="<?php echo $contact->label1; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pd-y-20 pd-r-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="phone1" name="phone1"
                                onchange="updateField('phone1' , 'contact_settings')"
                                value="<?php echo $contact->phone1; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pd-y-20 pd-l-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="label3" name="label3"
                                onchange="updateField('label3' , 'contact_settings')"
                                value="<?php echo $contact->label3; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pd-y-20 pd-r-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="email1" name="email1"
                                onchange="updateField('email1' , 'contact_settings')"
                                value="<?php echo $contact->email1; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="map" name="map" onchange="updateFieldMap('map' , 'contact_settings')"
                        value="<?php echo $contact->map; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
                <div id="googleMap" class="text-center">
                    <iframe src="<?php echo $contact->map; ?>" width="100%" height="150" frameborder="0"
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="settings" role="tabpanel">
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="meta_title" name="meta_title"
                        onchange="updateField('meta_title' , 'settings')" value="<?php echo $settings->meta_title; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="keywords" name="keywords" onchange="updateField('keywords' , 'settings')"
                        ...
                        class="form-control form-control-inverse transition pd-y-10" data-role="tagsinput">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <textarea id="description" name="description" rows="5"
                        onfocusout="updateTextarea('description' , 'settings')"
                        class="form-control form-control-inverse transition pd-y-10"><?php echo $settings->description; ?></textarea>
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="fb_link" name="fb_link" onchange="updateField('fb_link' , 'settings')"
                        value="<?php echo $settings->fb_link; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="captcha" name="captcha" onchange="updateField('captcha' , 'settings')"
                        value="<?php echo $settings->captcha; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="captcha_secret" name="captcha_secret"
                        onchange="updateField('captcha_secret' , 'settings')"
                        value="<?php echo @$settings->captcha_secret; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="tiny" name="tiny" onchange="updateField('tiny' , 'settings')"
                        value="<?php echo @$settings->tiny; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <textarea id="rodo" name="rodo" rows="5" onfocusout="updateTextarea('rodo' , 'settings')"
                        class="form-control form-control-inverse transition pd-y-10"><?php echo $settings->rodo; ?></textarea>
                </div>
            </div>
