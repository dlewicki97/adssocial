                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Filtruj: </label>
                                <input class="form-control" type="text" name="filter" value="<?php echo @$value->filter; ?>">
                            </div>
                        </div>
                        <div class="col-md-6 px-0">
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Link na przycisku: </label>
