            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-r-0-force bd-t-0-force">
                                <label class="form-control-label mg-b-0-force">Kategorie: <span class="tx-danger">*</span></label>

                                <div class="mt-3">
                                    <?php foreach($filters as $filter): ?>
                                        <label class="ckbox">
                                            <input name="filters[]" value="<?= $filter->id ?>" type="checkbox" <?php if(checkFilter($filter->id, $realizations_filters)) echo 'checked';  ?>>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <div id="photoViewer_2" class="form-group bd-t-0-force">
                            <label class="form-control-label">Tekst alternatywny logo:</label>
