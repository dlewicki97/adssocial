                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 px-0">
                                <div class="form-group bd-l-0-force ">
                                    <label class="form-control-label">Cudzysłów:</label>
                                    <textarea class="summernote" name="quote"><?php echo @$value->quote; ?></textarea>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force ">
                                    <label class="form-control-label">T:</label>
                                    <input class="form-control" name="phone" value="<?php echo @$value->phone; ?>" />
                                </div>
                            </div><!-- col-4 -->
                        </div> <!-- set -->
                        <div class="row">
