              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-50p text-right no-sort">
                    <a href="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/form/insert/<?php echo $this->uri->segment(4); ?>" class="btn btn-sm btn-info"><i class="fa fa-plus mg-r-10"></i> Dodaj</a>
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle">Wiersz <?php echo $i; ?></td>
                  <td class="text-right">
                      ...
                      onclick="return confirm('Czy na pewno chcesz usunąć Wiersz <?php echo $i; ?>?')" >
